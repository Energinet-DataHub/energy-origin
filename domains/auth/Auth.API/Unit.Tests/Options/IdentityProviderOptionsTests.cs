...
public class IdentityProviderOptionsTests
{
    ...
    [InlineData("openid ssn userinfo_token mitid nemid.pid", "mitid", null, ProviderType.MitID_Private)]
    [InlineData("openid ssn userinfo_token nemlogin", "mitid_erhverv", null, ProviderType.MitID_Professional)]
    [InlineData("openid ssn userinfo_token mitid nemid.pid nemlogin", "mitid mitid_erhverv", """{"mitid_erhverv": {"allow_private":true}}""", ProviderType.MitID_Private, ProviderType.MitID_Professional)]
    [InlineData("openid ssn userinfo_token nemid mitid nemid.pid", "nemid mitid", """{"nemid": {"amr_values": "nemid.otp"}}""", ProviderType.MitID_Private, ProviderType.NemID_Private)]
    ...
    [InlineData("openid ssn userinfo_token nemid private_to_business mitid nemid.pid nemlogin", "nemid mitid mitid_erhverv", """{"nemid": {"amr_values": "nemid.otp nemid.keyfile"}, "mitid_erhverv": {"allow_private":true}}""", ProviderType.MitID_Private, ProviderType.MitID_Professional, ProviderType.NemID_Private, ProviderType.NemID_Professional)]
