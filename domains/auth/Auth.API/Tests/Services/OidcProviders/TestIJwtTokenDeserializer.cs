...
{
    private readonly Mock<IJwtDeserializer> jwtDeserializer = new();
    ...
    public void LoginCallback_DeserializeUserIdToken_Succes()
    {
        ...
        var deserializedIdToken = jwtDeserializer.Object.DeserializeJwt<IdTokenInfo>(jwtEncoded);
    ...
    public void LoginCallback_DeserializeUserInfoToken_Succes()
    {
        ...
        var deserializedIdToken = jwtDeserializer.Object.DeserializeJwt<UserInfoToken>(jwtEncoded);
