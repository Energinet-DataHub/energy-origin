...
public class UserRepository : IUserRepository
{
    ...
    public async Task<User?> GetUserByIdAsync(Guid id) => await dataContext.Users.Include(x => x.Company).ThenInclude(x => x!.CompanyTerms).Include(x => x.UserProviders).Include(x => x.UserTerms).SingleOrDefaultAsync(x => x.Id == id);
