...
namespace API.AutoGenerated.Migrations
{
    ...
    [Migration("20230323205851_AddCompanyAndUserProviderTable")]
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "provider_key_type", new[] { "pid", "rid", "mit_id_uuid", "eia" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "provider_type", new[] { "nem_id_private", "mit_id_private", "nem_id_professional", "mit_id_professional" });
            ...
            modelBuilder.Entity("API.Models.Entities.UserProvider", b =>
                {
                    ...
                    b.Property<ProviderType>("ProviderType")
                    ...
                    b.HasIndex("ProviderType", "ProviderKeyType", "UserProviderKey");
