...
public class AuthorizationControllerTests : IntegrationTestBase, IClassFixture<IntegrationTestFixture>
{
    ...
    public AuthorizationControllerTests(IntegrationTestFixture integrationTestFixture) : base(integrationTestFixture)
    {
        ...
        _api = Fixture.WebAppFactory.CreateApi(sub: integrationTestFixture.WebAppFactory.IssuerIdpClientId.ToString());
    }
