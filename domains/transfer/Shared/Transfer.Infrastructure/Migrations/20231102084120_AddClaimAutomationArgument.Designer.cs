...
namespace DataContext.Migrations
{
    ...
    [Migration("20231102084120_AddClaimAutomationArgument")]
    partial class AddClaimAutomationArgument
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TransferAPI.Claiming.Api.Models.ClaimAutomationArgument", b =>
                {
            ...
            modelBuilder.Entity("TransferAPI.Connections.Api.Models.Connection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TransferAPI.Connections.Api.Models.ConnectionInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TransferAPI.Transfer.Api.Models.TransferAgreement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TransferAPI.Transfer.Api.Models.TransferAgreementHistoryEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TransferAPI.Transfer.Api.Models.TransferAgreementHistoryEntry", b =>
                {
                    b.HasOne("TransferAPI.Transfer.Api.Models.TransferAgreement", "TransferAgreement")
                        .WithMany()
