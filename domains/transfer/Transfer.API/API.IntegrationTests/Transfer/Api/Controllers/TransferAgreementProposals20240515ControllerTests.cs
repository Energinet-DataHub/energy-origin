...
public class TransferAgreementProposals20240515ControllerTests
{
    ...
    public TransferAgreementProposals20240515ControllerTests(IntegrationTestFixture integrationTestFixture)
    {
    ...
    public async Task Create()
    {
        ...
        var body = new CreateTransferAgreementProposal20240515(DateTimeOffset.UtcNow.AddMinutes(1).ToUnixTimeSeconds(), null, "12334455");
    ...
    public async Task Create_ShouldFail_WhenStartDateOrEndDateCauseOverlap()
    {
        ...
        var overlappingRequest = new CreateTransferAgreementProposal20240515(
    ...
    public async Task GetTransferAgreementProposal_ShouldReturnOK_WhenInvitationExists()
    {
        ...
        var request = new CreateTransferAgreementProposal20240515(DateTimeOffset.UtcNow.AddMinutes(1).ToUnixTimeSeconds(),
