    ...
    : MigrationsTestBase(integrationTestFixture)
{
    ...
    private static async Task InsertOldConnection(ApplicationDbContext dbContext, Guid id, Guid companyAId, string companyATin, Guid companyBId,
        string companyBTin)
    {
    ...
    private static async Task InsertOldConnectionInvitation(ApplicationDbContext dbContext, Guid id, Guid senderCompanyId, string senderCompanyTin,
