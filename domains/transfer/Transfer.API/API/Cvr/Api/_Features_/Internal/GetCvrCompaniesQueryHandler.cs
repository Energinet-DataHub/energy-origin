...
public record GetCvrCompaniesQuery(string Tin) : IRequest<GetCvrCompaniesQueryResult?>;

public record GetCvrCompaniesQueryResult(List<GetCvrCompaniesQueryResultItem> Result);

public record GetCvrCompaniesQueryResultItem(string Tin, string Name, string City, string ZipCode, string Address);
