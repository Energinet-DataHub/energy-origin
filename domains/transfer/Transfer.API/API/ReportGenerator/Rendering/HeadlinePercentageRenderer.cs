    ...
    public string Render(double percent, string periodLabel)
    {
        ...
        var html = $"""
                        <div data-layer="Grapth Top" class="GrapthTop" style="width: 562.99px; height: 75px; position: relative; background-color: #F9FAFB;">
                            ...
                            <div data-layer="{pct}%" style="width: 117px; height: 66px; left: 16px; top: 28px; position: absolute; color: #002433; font-size: 44px; font-family: OpenSansBolder; font-weight: 800; word-wrap: break-word">{pct}%</div>
