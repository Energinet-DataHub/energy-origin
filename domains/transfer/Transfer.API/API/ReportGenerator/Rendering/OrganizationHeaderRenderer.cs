    ...
    public string Render(string organizationName, string taxIdentificationNumber)
    {
        ...
        var html = $"""
                    ...
                    <div data-layer="header" class="header" style="width: 531px;height: 104px;position: relative;padding-bottom: 22px;">
                        ...
                        <div data-layer="Granulære oprindelsesgarantier" class="GranulReOprindelsesgarantier" style="width: 531px; left: 14px; top: 22px; padding-bottom: 32px; position: relative; color: #002433; font-size: 47px; font-family: OpenSansBold; font-weight: 700; line-height: 51.70px; word-wrap: break-word">
