        ...
        var html = $"""
                    ...
                    <div data-layer="header" class="header" style="width: 531px;height: 104px;position: relative;padding-bottom: 22px;">
                        <div data-layer="Frame 17" class="Frame17" style="width: 531px; height: 33px; padding-left: 0px; padding-right: 18px; left: 14px; top: 0px; position: absolute; justify-content: flex-start; align-items: flex-start; display: inline-flex">
                            <div data-layer="Markedsrapport baseret på" class="MarkedsrapportBaseretP" style="color: #002433; font-size: 12px; font-family: OpenSansNormal; font-weight: 400; letter-spacing: 1.20px; word-wrap: break-word">Markedsrapport baseret på</div>
                        </div>
                        <div data-layer="Granulære oprindelsesgarantier" class="GranulReOprindelsesgarantier" style="width: 531px; left: 14px; top: 22px; padding-bottom: 32px; position: relative; color: #002433; font-size: 47px; font-family: OpenSansBold; font-weight: 700; line-height: 51.70px; word-wrap: break-word">Granulære oprindelsesgarantier</div>
                    </div>
                    """;
