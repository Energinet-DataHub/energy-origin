...
public record CreateTransferAgreementProposalRequest(
...
public class CreateTransferAgreementProposalRequestValidator : AbstractValidator<CreateTransferAgreementProposalRequest>
{
    public CreateTransferAgreementProposalRequestValidator()
    {
