...
public class TransferEngineUtilityTest
{
    ...
    public TransferEngineUtilityTest()
    {
        ...
        _sut = new TransferEngineUtility(_mockWalletClient, _requestStatusRepository);
    }
    ...
    [Fact]
    public async Task GivenCompletedTransactions_WhenCheckingStatus_StatusIsNotUpdate()
    {
