...
public class TransferCertificatesBasedOnConsumptionEngineTest
{
    ...
    public TransferCertificatesBasedOnConsumptionEngineTest()
    {
        ...
        var transferEngineUtility = new TransferEngineUtility(mockWalletClient, requestStatusStore) { BatchSize = batchSize };
        ...
        TransferResponse mockedTransferResponse)
    {
        ...
        mockWalletClient.GetGranularCertificates(Arg.Is(owner), Arg.Any<CancellationToken>(), Arg.Any<int?>()).Returns(
