...
public class SwaggerTests : TestBase
{
    ...
    [Fact]
    public async Task GetSwaggerUI_AppStarted_ReturnsOkAndHtml()
    {
        await factory.WithApiVersionDescriptionProvider(async _ =>
        {
    ...
    public async Task SwaggerDoc_ContainsBearerSecurityDefinition()
    {
        await factory.WithApiVersionDescriptionProvider(async apiDesc =>
        {
            ...
            foreach (var description in apiDesc.ApiVersionDescriptions.Select(v => v.GroupName))
            {
    ...
    public async Task GetSwaggerDoc_AppStarted_LatestVersionNoChangesAccordingToSnapshot()
    {
        await factory.WithApiVersionDescriptionProvider(async apiDesc =>
        {
            ...
            var latestVersion = apiDesc.ApiVersionDescriptions
