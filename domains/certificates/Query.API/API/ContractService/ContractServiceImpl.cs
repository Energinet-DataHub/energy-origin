...
internal class ContractServiceImpl : IContractService
{
    ...
    private readonly IAuthorizationMetricsCert _metrics;
    ...
    public ContractServiceImpl(
        ...
        IAuthorizationMetricsCert _metrics)
    {
        ...
        string organizationTin, CancellationToken cancellationToken)
    {
        for (int i = 0; i < 10; i++)
        {
            ...
            _metrics.AddUniqueUserLogin(subjectId.ToString(), subjectId.ToString());
        }
