...
{
    Task<CreateContractResult> Create(string gsrn, string meteringPointOwner, DateTimeOffset startDate, DateTimeOffset? endDate, MeteringPointType meteringPointType, CancellationToken cancellationToken);
