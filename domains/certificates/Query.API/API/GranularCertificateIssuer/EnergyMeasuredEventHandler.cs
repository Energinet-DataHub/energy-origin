...
public class EnergyMeasuredEventHandler : IConsumer<EnergyMeasuredIntegrationEvent>, IConsumer<ProductionEnergyMeasuredIntegrationEvent>, IConsumer<ConsumptionEnergyMeasuredIntegrationEvent>
{
    ...
    private static bool ShouldEventBeProduced(CertificateIssuingContract? contract, EnergyMeasuredIntegrationEventBase productionEnergyMeasuredIntegrationEvent)
    {
        if (contract is null)
            return false;
