...
public class CertificatesService : ICertificatesService
{
    ...
    {
        // return new GetContractsForAdminPortalResponse(new []{new GetContractsForAdminPortalResponseItem("1", "2", DateTimeOffset.Now.ToUnixTimeSeconds(),DateTimeOffset.Now.ToUnixTimeSeconds(),null, MeteringPointType.Production)});
