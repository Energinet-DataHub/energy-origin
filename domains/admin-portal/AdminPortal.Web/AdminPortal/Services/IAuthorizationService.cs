...
public class AuthorizationService : IAuthorizationService
{
    ...
    //private GetWhitelistedOrganizationsResponseItem[] _whitelist;

    public AuthorizationService(HttpClient client)
    {
        _client = client;
        //_whitelist = new[] { new GetWhitelistedOrganizationsResponseItem(Guid.NewGuid(), "12345678"), new GetWhitelistedOrganizationsResponseItem(Guid.NewGuid(), "66778899") };
    }

    public async Task<GetOrganizationsResponse> GetOrganizationsAsync(CancellationToken cancellationToken)
    {
        //return new GetOrganizationsResponse(new[] { new GetOrganizationsResponseItem(Guid.NewGuid(), "Acme", "12345678") });
    ...
    {
        //return new GetWhitelistedOrganizationsResponse(_whitelist);
