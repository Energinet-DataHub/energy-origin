...
using CleanTransfer.Core.ProjectAggregate;
using CleanTransfer.Core.Services;
using CleanTransfer.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace CleanTransfer.UnitTests.Core.Services
{
